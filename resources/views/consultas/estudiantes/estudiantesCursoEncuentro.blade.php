...
<form action="/estudiantesCursoEncuentro" id="formulario_estudiantes_curso_encuentro" method="get">
    @csrf
    ...
    @else
        <script>
            @if(isset($carreraParam) && $carreraParam)
                alert('No hay estudiantes del curso por encuentro en esa carrera');
            @endif
        </script>
    @endif
@endif
