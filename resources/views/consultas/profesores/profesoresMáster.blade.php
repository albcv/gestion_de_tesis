...
@if(isset($profesores))
        ...
        <div class="resultado-info">
            <p style="text-align: center;">
                @if(isset($departamentoParam) && $departamentoParam)
                    ...
                    @endphp
                    Profesores con categoría "Máster en Ciencias" del <strong>{{ $departamentoNombre }}</strong>: {{ count($profesores) }}
                @else
                    Total de profesores Máster en Ciencias encontrados: {{ count($profesores) }}
                @endif
            </p>
        </div>
    ...
    @else
        <script>
            @if(isset($departamentoParam) && $departamentoParam)
                alert('No se encontraron profesores con categoría "Máster en Ciencias" en ese departamento');
            @endif
        </script>
    @endif
@endif
