...
<form action="{{ route('profesoresDoctores') }}" method="GET">
    @csrf
...
@if(isset($profesores))
        ...
        <div class="resultado-info">
            <p style="text-align: center;">
                @if(isset($departamentoParam) && $departamentoParam)
                    ...
                    @endphp
                    Profesores con categoría "Doctor en Ciencias" del <strong>{{ $departamentoNombre }}</strong>: {{ count($profesores) }}
                @else
                    Total de profesores Doctores en Ciencias encontrados: {{ count($profesores) }}
                @endif
            </p>
        </div>
    ...
    @else
        <script>
            @if(isset($departamentoParam) && $departamentoParam)
                alert('No se encontraron profesores con categoría "Doctor en Ciencias" en ese departamento');
            @endif
        </script>
    @endif
@endif
