...
{
    protected $modelo = version_corte::class;
    protected $storageFolder = 'versiones_corte';
    protected $allowedExtensions = ['pdf', 'doc', 'docx'];
    protected $rutaVista = 'gestionarVersiónCorte';
    ...
    public function mostrar()
    {
        ...
        return view('gestionar.gestionarVersiónCorte', compact('objetos'));
    }
    ...
    public function agregar(Request $request)
    {
        $request->validate([
            ...
            'enlace' => 'required|file|max:10240'
        ]);
        ...
        if ($request->hasFile('documento')) {
            ...
            $obj->id_corte = $request->id_corte;
            $obj->Enlace_Github = $request->enlace;
            $obj->save();
        }
    ...
    public function verDocumento($id)
    {
        ...
        $fileName = 'corte_tesis_' . $obj->id_corte . '.' . 
